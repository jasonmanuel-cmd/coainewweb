        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            <div>
              ...
              <a href="tel:+16615694244" style={{ fontSize: "1.8rem", fontWeight: 800, color: "var(--accent-green)" }}>(661) 569-4244</a>
            ...
            <div>
              ...
              <a href="mailto:jasonm@coaibakersfield.com" style={{ fontSize: "1.2rem", fontWeight: 700, color: "#fff" }}>jasonm@coaibakersfield.com</a>
            </div>
          ...
          <div className="pkg-card" style={{ padding: "40px" }}>
            {done ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ fontSize: ".9rem", color: "var(--text-soft)", lineHeight: 1.6, marginBottom: "24px" }}>Jason will respond same business day. Data has been routed to <strong>jasonm@coaibakersfield.com</strong>. If it&apos;s urgent, call (661) 569-4244.</p>
              ...
              <>
                ...
                <p style={{ fontSize: ".85rem", color: "var(--text-muted)", marginBottom: "32px" }}>Submissions go to jasonm@coaibakersfield.com. Jason responds same business day.</p>
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  ...
                  <p style={{ textAlign: "center", fontSize: ".72rem", color: "var(--text-muted2)", marginTop: "12px" }}>
                    ...
                    Data routed to: jasonm@coaibakersfield.com
                  </p>
                </form>
              </>
            )}
