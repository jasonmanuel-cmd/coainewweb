          ...
          <div className="pkg-card" style={{ padding: "40px" }}>
            {done ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ fontSize: ".9rem", color: "var(--text-soft)", lineHeight: 1.6, marginBottom: "24px" }}>Jason will respond same business day. If it&apos;s urgent, call (661) 569-4244.</p>
              ...
              <>
                ...
                <p style={{ fontSize: ".85rem", color: "var(--text-muted)", marginBottom: "32px" }}>Jason responds same business day.</p>
