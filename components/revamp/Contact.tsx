    ...
    <div>
      <section style={{ padding: "100px 0 60px", background: "linear-gradient(180deg, rgba(3,3,6,0), rgba(232,160,32,0.05))" }}>
        <div className="container" style={{ position: "relative" }}>
          ...
          <p className="section-sub">Jason responds same business day. If it&apos;s urgent, call directly — (661) 331-1767. He picks up.</p>
        </div>
      </section>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            <div>
              ...
              <a href="tel:+16613311767" style={{ fontSize: "1.8rem", fontWeight: 800, color: "var(--accent)" }}>(661) 331-1767</a>
          ...
          <div className="pkg-card" style={{ padding: "40px" }}>
            {done ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ fontSize: ".9rem", color: "var(--text-soft)", lineHeight: 1.6, marginBottom: "24px" }}>Jason will respond same business day. Data has been routed to <strong>jasonm@coaibakersfield.com</strong> &amp; <strong>frankh@coaibakersfield.com</strong>. If it&apos;s urgent, call (661) 331-1767.</p>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  ...
                  <p style={{ textAlign: "center", fontSize: ".72rem", color: "var(--text-muted2)", marginTop: "12px" }}>
                    Or skip the form — call (661) 331-1767 directly.<br/>
