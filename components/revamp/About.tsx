    ...
    <div>
      ...
      <section style={{ padding: "100px 0 60px", background: "linear-gradient(180deg, rgba(3,3,6,0), rgba(232,160,32,0.05))" }}>
        <div className="container">
          ...
          <h1 className="section-title">Built by someone who&apos;s<br /><span className="text-amber">actually been in the field.</span></h1>
      ...
      <div className="container" style={{ paddingBottom: 100 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "60px", alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            <div className="pkg-card" style={{ padding: 0, overflow: "hidden", textAlign: "center" }}>
              ...
              <div style={{ padding: "28px 32px 32px" }}>
                ...
                <div style={{ fontSize: ".8rem", color: "var(--accent)", fontWeight: 700, marginBottom: "20px", fontFamily: "var(--font-mono)", letterSpacing: "1px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  <a href="tel:+16616591376" className="btn-primary" style={{ width: "100%", justifyContent: "center" }}>
                    Call Jason Directly
                  </a>
            ...
            <div className="pkg-card" style={{ padding: "24px", borderColor: "rgba(232,160,32,0.2)", background: "rgba(232,160,32,0.04)" }}>
              <div style={{ fontSize: ".7rem", fontFamily: "var(--font-mono)", color: "var(--accent)", marginBottom: "10px", letterSpacing: "1px" }}>PRIMARY TAGLINE</div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
            ...
            <div className="pkg-card" style={{ padding: "28px", borderColor: "rgba(232,160,32,0.15)", background: "rgba(232,160,32,0.03)" }}>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: ".72rem", color: "var(--accent)", marginBottom: "10px", letterSpacing: "1px" }}>THE ANTI-DEPENDENCY THESIS</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "20px", margin: "80px 0" }}>
          {METRICS.map(m => (
            <div key={m.label} className="pkg-card" style={{ padding: "28px", textAlign: "center" }}>
              <div style={{ fontSize: "2.2rem", fontWeight: 900, color: "var(--accent)", marginBottom: "8px" }}>{m.value}</div>
        ...
        <div style={{ marginBottom: "80px" }}>
          ...
          <h2 className="section-title">The <span className="text-amber">Tripod System.</span></h2>
        ...
        <div style={{ marginBottom: "80px" }}>
          ...
          <h2 className="section-title">What we build <span className="text-amber">with.</span></h2>
        ...
        <div style={{ marginBottom: "80px" }}>
          ...
          <h2 className="section-title">The <span className="text-amber">Team Good Protocol.</span></h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "24px", marginTop: "40px" }}>
            {VALUES.map(v => (
              <div key={v.code} className="pkg-card" style={{ padding: "28px" }}>
                <div style={{ fontSize: ".7rem", fontWeight: 800, color: "var(--accent)", marginBottom: "10px", fontFamily: "var(--font-mono)" }}>{v.code}</div>
        ...
        {/* CTA */}
        <div className="pkg-card" style={{ padding: "60px", textAlign: "center", borderColor: "rgba(232,160,32,0.2)", background: "rgba(232,160,32,0.03)" }}>
          <span className="section-eyebrow" style={{ justifyContent: "center", display: "block" }}>Ready to Fix the Leaks?</span>
          <h2 style={{ fontSize: "2rem", fontWeight: 800, color: "#fff", marginBottom: "16px" }}>Your infrastructure is your<br /><span className="text-amber">most valuable asset.</span></h2>
          ...
          <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="tel:+16616591376" className="btn-secondary">Call (661) 659-1376</a>
          </div>
        </div>
