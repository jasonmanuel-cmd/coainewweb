...
const SVC = [
  ...
  { name: "LeadShield Setup", cat: "Build", price: "$497", freq: "One-time", pri: "High", isnew: 0, desc: "Sovereign missed-call text-back system, deployed and configured. Automated SMS follow-up and lead dashboard so no lead goes dark — ever." },
  ...
  { name: "LeadShield Management", cat: "Recurring", price: "$150/mo", freq: "Monthly", pri: "High", isnew: 0, desc: "Monitoring automated SMS replies, lead dashboard efficiency, and response rate reporting." },
